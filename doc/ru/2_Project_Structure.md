...
*doc* - директория, содержащая данную пошаговую инструкцию и др. документацию

*code* - директория, содержащия файлы проекта, из которых будет компилироваться учебный плагин для quik с использованием библиотеки qluacpp

*code/contrib* - директория для сторонних библиотек, в том числе qluacpp

*code/src* - исходные файлы нашего плагина
