...
### Базовая конфигурация CMakeLists.txt ###
...
### Указываем путь к загаловкам скаченной библиотеки Lua для qluacpp (4.5) ###
...
Создаем файл [qluacpp_tutorial.cpp](src/qlua_tutorial.cpp) в директории [src](src)

### Пишем "основу" плагина в qluacpp_tutorial.cpp ###
...
#### Подключение qluacpp в инициализационной функции ####
